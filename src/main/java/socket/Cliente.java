...
public class Cliente {
	public static void main(String[] args) {
		...
		try {
			...
			/**
			 * Utilizamos Thread para garantir o paralelismo entre cliente e servidor: 1.
			 * Ler mensagens enviadas do servidor 2. Ao mesmo tempo enviar mensagem ao
			 * servidor
			 */
				...
				try {
					while (!finalCliente.isClosed()) {
						try {
							...
							// conexao do servidor foi encerrada enquanto o cliente tentava enviar uma
							// mensagem
							System.out.println(
									"O cliente perdeu a conexão com o servidor." + "\nPara encerrar digite '::sair'");
							break;
